...
export function createClient() {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    throw new Error('Missing NEXT_PUBLIC_SUPABASE_URL or NEXT_PUBLIC_HEALTH_LEAGUE_SUPABASE_URL, and NEXT_PUBLIC_SUPABASE_ANON_KEY or NEXT_PUBLIC_HEALTH_LEAGUE_SUPABASE_ANON_KEY');
  }
