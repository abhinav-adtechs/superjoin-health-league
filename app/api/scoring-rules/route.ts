...
// Updated fallback to match new goal-centric scoring system.
const FALLBACK_RULES: ScoringRule[] = [
  ...
  { id: 4,  category: 'movement',       category_max: 25,   sort_order: 10, action_label: 'Complete any cardio session',            field_name: 'cardio_done',      condition_desc: 'cardio_done = true',                                     points: 10,  is_bonus: false, age_adjusted: false, age_note: null },
  { id: 5,  category: 'movement',       category_max: 25,   sort_order: 20, action_label: 'Cardio for 30+ minutes',                 field_name: 'cardio_duration',  condition_desc: 'cardio_duration >= 30 min',                              points: 5,   is_bonus: true,  age_adjusted: true,  age_note: 'Over 35: threshold is 25.5 min (85%)' },
  { id: 6,  category: 'movement',       category_max: 25,   sort_order: 30, action_label: '10,000+ steps',                          field_name: 'steps',            condition_desc: 'steps >= 10,000 (stacks with cardio, capped at 25)',     points: 10,  is_bonus: true,  age_adjusted: true,  age_note: 'Over 35: threshold is 8,500 steps (85%)' },
  { id: 7,  category: 'movement',       category_max: 25,   sort_order: 40, action_label: '7,500+ steps',                           field_name: 'steps',            condition_desc: 'steps >= 7,500',                                         points: 7,   is_bonus: true,  age_adjusted: true,  age_note: 'Over 35: threshold is 6,375 steps (85%)' },
  { id: 8,  category: 'movement',       category_max: 25,   sort_order: 50, action_label: '5,000+ steps',                           field_name: 'steps',            condition_desc: 'steps >= 5,000',                                         points: 5,   is_bonus: true,  age_adjusted: true,  age_note: 'Over 35: threshold is 4,250 steps (85%)' },
  // Sleep (max 10, quality removed)
  { id: 9,  category: 'sleep',          category_max: 10,   sort_order: 10, action_label: 'Optimal sleep (7–9 hours)',              field_name: 'sleep_hours',      condition_desc: 'sleep_hours >= 7 AND <= 9',                              points: 10,  is_bonus: false, age_adjusted: false, age_note: null },
  { id: 10, category: 'sleep',          category_max: 10,   sort_order: 15, action_label: 'Good sleep (6–7 hours)',                 field_name: 'sleep_hours',      condition_desc: 'sleep_hours >= 6 AND < 7',                               points: 5,   is_bonus: false, age_adjusted: false, age_note: null },
  // Nutrition (max 26)
  { id: 11, category: 'nutrition',      category_max: 26,   sort_order: 10, action_label: 'Drink 3+ litres of water',               field_name: 'water_liters',     condition_desc: 'water_liters >= 3',                                      points: 10,  is_bonus: false, age_adjusted: false, age_note: null },
  { id: 12, category: 'nutrition',      category_max: 26,   sort_order: 15, action_label: 'Drink 2–3 litres of water',              field_name: 'water_liters',     condition_desc: 'water_liters >= 2 AND < 3',                              points: 5,   is_bonus: false, age_adjusted: false, age_note: null },
  { id: 13, category: 'nutrition',      category_max: 26,   sort_order: 30, action_label: 'Protein goal hit',                       field_name: 'protein_qty',      condition_desc: 'protein_qty >= goal_protein_g_day (goal must be set)',   points: 8,   is_bonus: false, age_adjusted: false, age_note: null },
  { id: 14, category: 'nutrition',      category_max: 26,   sort_order: 31, action_label: 'Protein goal partial',                   field_name: 'protein_qty',      condition_desc: 'protein_qty > 0 but below target',                      points: 4,   is_bonus: false, age_adjusted: false, age_note: null },
  { id: 15, category: 'nutrition',      category_max: 26,   sort_order: 32, action_label: 'Calorie goal aligned',                   field_name: 'calories_kcal',    condition_desc: 'calories within goal direction per fitness goal',         points: 8,   is_bonus: false, age_adjusted: false, age_note: 'Cutting: stay under budget · Bulking: hit or exceed target' },
  { id: 16, category: 'nutrition',      category_max: 26,   sort_order: 33, action_label: 'Calorie goal partial',                   field_name: 'calories_kcal',    condition_desc: 'Partially aligned (within 10-15% margin)',               points: 4,   is_bonus: false, age_adjusted: false, age_note: null },
  // Logging streak
  ...
  { id: 28, category: 'goal_crush',     category_max: null, sort_order: 40, action_label: '30-day goal crush streak',               field_name: 'is_goal_crush_day',condition_desc: 'consecutive goal crush days = 30',                       points: 200, is_bonus: false, age_adjusted: false, age_note: null },
  { id: 29, category: 'goal_crush',     category_max: null, sort_order: 50, action_label: 'Every 30 days beyond 30',                field_name: 'is_goal_crush_day',condition_desc: 'consecutive goal crush days mod 30 = 0 (after 30)',       points: 200, is_bonus: false, age_adjusted: false, age_note: null },
];
